...
class Ex02_V2 extends Frame implements ActionListener {
    private JFrame f;
    ...
    Ex02_V2 (String titulo, int largura, int altura, int colinic, int lininic)
    {
        f = new JFrame(titulo);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bOk) {
            ...
            else if(cbSexo.getSelectedIndex() != 0 && cbSexo.getSelectedIndex() != 1)
            {
            ...
            {
                UmaPessoa = new Pessoa(tfNome.getText(), cbSexo.getSelectedItem().toString().charAt(0), Integer.parseInt(tfIdade.getText()));
            }
        }
            ...
            cbSexo.setSelectedItem(UmaPessoa.getSexo());
        }
    ...
    public static void main(String[] args) {
        new Ex02_V2("Ex02", 400, 250, 10, 10);
    }
}
